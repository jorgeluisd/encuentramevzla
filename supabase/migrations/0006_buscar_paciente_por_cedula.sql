-- ============================================================================
-- 0006_buscar_paciente_por_cedula.sql — La búsqueda también acepta cédula/ID.
--
-- Antes el RPC solo matcheaba por nombre. Ahora, si el término normalizado a
-- alfanumérico tiene >= 6 dígitos, también busca coincidencia EXACTA de documento
-- (señal fuerte: strength = 1). El nombre sigue funcionando igual.
-- ============================================================================
